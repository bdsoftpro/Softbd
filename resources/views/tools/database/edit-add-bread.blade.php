...
@section('page_header')
    <div class="page-title">
        <i class="softbd-data"></i> @if(isset($dataType->id)){{ 'Edit BREAD for ' . $dataType->name . ' table' }}@elseif(isset($table)){{ 'Create BREAD for ' . $table . ' table' }}@endif
    </div>
    @php
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="@if(isset($dataType->id)){{ route('softbd.database.bread.update', $dataType->id) }}@else{{ route('softbd.database.bread.store') }}@endif"
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    ...
                                    @if($isModelTranslatable)
                                        @include('softbd::multilingual.input-hidden', [
                        ...
                        <div class="panel-body">
                            <table id="users" class="table table-hover">
                                ...
                                @foreach($fieldOptions as $data)
                                    ...
                                    @if(isset($dataType->id))
                                        <?php $dataRow = SBD\Softbd\Models\DataRow::where('data_type_id', '=',
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <select name="field_input_type_{{ $data['field'] }}">
                                                    @foreach (Softbd::formFields() as $formField)
