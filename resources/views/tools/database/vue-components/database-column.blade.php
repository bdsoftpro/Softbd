...
<tr class="newTableRow">
    ...
    <td>
        <div class="btn btn-danger delete-row" @click="deleteColumn"><i class="softbd-trash"></i></div>
    </td>
...
@include('softbd::tools.database.vue-components.database-types')
@include('softbd::tools.database.vue-components.database-column-default')
