...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ softbd_asset('css/ga-embed.css') }}">
@stop

@section('content')
    <div class="page-content">
        @include('softbd::alerts')
        @include('softbd::dimmers')
        <div style="padding:15px;">
            <?php $google_analytics_client_id = Softbd::setting("google_analytics_client_id"); ?>
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script src="{{ softbd_asset('js/ga-embed/chart.min.js') }}"></script>
        <script src="{{ softbd_asset('js/ga-embed/moment.min.js') }}"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="{{ softbd_asset('js/ga-embed/view-selector2.js') }}"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="{{ softbd_asset('js/ga-embed/date-range-selector.js') }}"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="{{ softbd_asset('js/ga-embed/active-users.js') }}"></script>
