...
@section('css')
    <script type="text/javascript" src="{{ softbd_asset('js/vue1.min.js') }}"></script>
    <link rel="stylesheet" href="{{ softbd_asset('css/media/media.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ softbd_asset('js/select2/select2.min.css') }}">
    <link rel="stylesheet" href="{{ softbd_asset('css/media/dropzone.css') }}"/>
@stop
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="admin-section-title">
                    <h3><i class="softbd-images"></i> Media</h3>
                </div>
                <div class="clear"></div>
                ...
                <div id="filemanager">
                    ...
                    <div id="toolbar">
                        <div class="btn-group offset-right">
                            <button type="button" class="btn btn-primary" id="upload"><i class="softbd-upload"></i>
                                Upload
                            </button>
                            <button type="button" class="btn btn-primary" id="new_folder"
                                    onclick="jQuery('#new_folder_modal').modal('show');"><i class="softbd-folder"></i>
                                Add folder
                            </button>
                        </div>
                        <button type="button" class="btn btn-default" id="refresh"><i class="softbd-refresh"></i>
                        </button>
                        <div class="btn-group offset-right">
                            <button type="button" class="btn btn-default" id="move"><i class="softbd-move"></i> Move
                            </button>
                            <button type="button" class="btn btn-default" id="rename"><i class="softbd-character"></i>
                                Rename
                            </button>
                            <button type="button" class="btn btn-default" id="delete"><i class="softbd-trash"></i>
                                Delete
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="content">
                        ...
                        <div class="breadcrumb-container">
                            ...
                            <div class="toggle"><span>Close</span><i class="softbd-double-right"></i></div>
                        </div>
                        <div class="flex">
                            ...
                            <div id="left">
                                ...
                                <div id="no_files">
                                    <h3><i class="softbd-meh"></i> No files in this folder.</h3>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i class="softbd-move"></i> Move File/Folder</h4>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">&times;</button>
                                    <h4 class="modal-title"><i class="softbd-character"></i> Rename File/Folder</h4>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="softbd-folder"></i> Add New Folder</h4>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="softbd-warning"></i> Are You Sure</h4>
                            </div>

                            <div class="modal-body">
                                <h4>Are you sure you want to delete '<span class="confirm_delete_name"></span>'</h4>
                                <h5 class="folder_warning"><i class="softbd-warning"></i> Deleting a folder will remove
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="softbd-warning"></i> Drag and drop files or click
                                    below to upload</h4>
                            </div>
...
@section('javascript')
<script src="{{ softbd_asset('js/media/dropzone.js') }}"></script>
<script src="{{ softbd_asset('js/media/media.js') }}"></script>
<script type="text/javascript">
    var media = new SoftbdMedia({
        baseUrl: "{{ route('softbd.dashboard') }}"
    });
    $(function () {
        media.init();
    });
