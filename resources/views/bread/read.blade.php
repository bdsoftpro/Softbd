...
@section('page_header')
    <h1 class="page-title">
        ...
        <a href="{{ route('softbd.'.$dataType->slug.'.edit', $dataTypeContent->getKey()) }}" class="btn btn-info">
            <span class="glyphicon glyphicon-pencil"></span>&nbsp;
            Edit
        </a>
        @endif
        <a href="{{ route('softbd.'.$dataType->slug.'.index') }}" class="btn btn-warning">
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            @if($row->type == "image")
                                <img class="img-responsive"
                                     src="{{ Softbd::image($dataTypeContent->{$row->field}) }}">
                            ...
                            @elseif($row->type == 'rich_text_box')
                                @include('softbd::multilingual.input-hidden-bread-read')
