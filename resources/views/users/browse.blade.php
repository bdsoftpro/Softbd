                        ...
                        <table id="dataTable" class="table table-hover">
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr>
                                    ...
                                    <td>
                                        <img src="@if( strpos($data->avatar, 'http://') === false && strpos($data->avatar, 'https://') === false){{ Softbd::image( $data->avatar ) }}@else{{ $data->avatar }}@endif" style="width:100px">
                                    </td>
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        @if (Softbd::can('read_'.$dataType->name))
                                            <a href="{{ route('softbd.'.$dataType->slug.'.show', $data->id) }}" class="btn-sm btn-warning pull-right">
