...
use SBD\Softbd\Traits\AlertsMessages;
...
class DatabaseTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        // Create table
        $this->post(route('softbd.database.store'), [
    ...
    public function test_table_created_successfully()
    {
        ...
        $this->assertRedirectedToRoute('softbd.database.edit', $this->table['name']);
    ...
    public function test_can_drop_table()
    {
        ...
        $this->delete(route('softbd.database.destroy', $this->table['name']));

        // Test correct response
        $this->assertSessionHasAll($this->alertSuccess("Successfully deleted {$this->table['name']} table"));
        $this->assertRedirectedToRoute('softbd.database.index');
    ...
    protected function update_table_that_not_exist()
    {
        ...
        $this->put(route('softbd.database.update', $table['oldName']), [
    ...
    protected function update_table(array $table)
    {
        ...
        $this->assertRedirectedToRoute('softbd.database.edit', $table['name']);
