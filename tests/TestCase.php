...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup Softbd configuration
        $app['config']->set('softbd.user.namespace', User::class);
    ...
    protected function install()
    {
        ...
        $this->artisan('softbd:install', ['--with-dummy' => $this->withDummy]);

        config()->set(
            'softbd',
            require __DIR__.'/../publishable/config/softbd.php'
        );
    }
