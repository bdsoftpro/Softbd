...
use SBD\Softbd\Translator\Collection;
...
class MultilingualTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        config()->set('softbd.multilingual.locales', ['en', 'da']);

        // Turn on multilingual
        config()->set('softbd.multilingual.bread', true);
    }

    public function testCheckingModelIsTranslatable()
    {
        $this->assertTrue(Softbd::translatable(TranslatableModel::class));
        $this->assertTrue(Softbd::translatable(ActuallyTranslatableModel::class));
    }

    public function testCheckingModelIsNotTranslatable()
    {
        $this->assertFalse(Softbd::translatable(NotTranslatableModel::class));
        $this->assertFalse(Softbd::translatable(StillNotTranslatableModel::class));
    }
