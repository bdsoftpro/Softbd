$(document).ready(function(){
  ...
  sidebarAnchor.on('click', function(){
    if (appContainer.hasClass('expanded')) {
      if ($(this).hasClass('active')) {
        ...
        window.localStorage.removeItem('softbd.stickySidebar');
        ...
        window.localStorage.setItem('softbd.stickySidebar', true);
  ...
  $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-collapse"]', function(e){
    ...
    if(!$this.hasClass('panel-collapsed')) {
      ...
      $this.removeClass('softbd-angle-down').addClass('softbd-angle-up');
    } else {
      $this.parents('.panel').find('.panel-body').slideDown();
      $this.removeClass('panel-collapsed');
      $this.removeClass('softbd-angle-up').addClass('softbd-angle-down');
    }
  });
  ...
  $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-fullscreen"]', function (e) {
    e.preventDefault();
    var $this = $(this);
    if (!$this.hasClass('softbd-resize-full')) {
      $this.removeClass('softbd-resize-small').addClass('softbd-resize-full');
    } else {
      $this.removeClass('softbd-resize-full').addClass('softbd-resize-small');
    }
